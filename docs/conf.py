# -*- coding: utf-8 -*-
#
# SQLAlchemy-ImageAttach documentation build configuration file, created by
# sphinx-quickstart on Tue May 28 15:40:57 2013.
#
...
copyright = u'2013–2014, Hong Minhee'
...
htmlhelp_basename = 'SQLAlchemy-ImageAttachdoc'
...
latex_documents = [
  ('index', 'SQLAlchemy-ImageAttach.tex', 'SQLAlchemy-ImageAttach Documentation',
   'Hong Minhee', 'manual'),
]
...
man_pages = [
    ('index', 'sqlalchemy-imageattach', 'SQLAlchemy-ImageAttach Documentation',
     ['Hong Minhee'], 1)
]
...
texinfo_documents = [
  ('index', 'SQLAlchemy-ImageAttach', 'SQLAlchemy-ImageAttach Documentation',
   'Hong Minhee', 'SQLAlchemy-ImageAttach', 'One line description of project.',
   'Miscellaneous'),
]
